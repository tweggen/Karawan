...
public class PlayerWaypoint : IWaypoint
{
    ...
    public Vector3 GetLocation()
    {
        if (!_engine.Player.TryGet(out _eCarrot))
        {
             ...
             */
            Trace(_dc, $"No player available. Returning last known position.");
            _eCarrot = default;
        }
        ...
        if (!_eCarrot.IsAlive) 
        {
            Trace(_dc, $"Player entity is not alive at this moment.");
            return _v3LastPosition;
        }
        ...
        if (!_eCarrot.IsEnabled())
        {
            ...
            Error(_dc, $"Player entity is not enabled at this moment.");
            return _v3LastPosition;
        }
        ...
        if (!_eCarrot.Has<Transform3ToWorld>())
        {
            ...
            Error(_dc, $"Player entity has no transform to world at this moment. Returning last known position.");
            return _v3LastPosition;
        }
