"""
WP-5.1 generator: emit Splash.API.OpenGL from surface.json + gl.xml.

Scope is the narrow form the owner chose: only the surface Splash.OpenGL actually binds
...
SUPPORT = [
    ...
    # KHR_debug. Used by Splash.OpenGL/GlDiagnostics.cs to replace glGetError polling.
    #
...
L.append('//')
L.append('//   Scope is the surface Splash.OpenGL actually binds to (the narrow form of S2a),')
