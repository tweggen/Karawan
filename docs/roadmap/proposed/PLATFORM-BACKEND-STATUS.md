...
| **WP-6.3 leftovers** | 🟡 **F8 and the cursor keys confirmed 2026-08-15.** Enter unreported; an Android re-check of `SetKeyboardVisible` still open. |
