 ...
 * bool, to [Conditional("DEBUG")], to nothing at all. Fourteen sites in GlThreeD were
 ...
 * branch the JIT hopefully folds: no IL at all. Splash.OpenGL.csproj defines the symbol for
