...
/*
 * WP-5.4: a #if GLES / #elif GL / #elif LEGACY block used to sit here, selecting
 * between three Silk.NET GL flavours. None of those symbols is defined anywhere
 * in the build - no DefineConstants sets GLES, GL or LEGACY - so the block always
 * compiled to nothing and the import above is the one that was ever in effect. It
 * came in with the upstream Silk ImGui sample and outlived the binding it chose
 * between.
 */
using Point = System.Drawing.Point;
using static engine.Logger;

namespace Splash.OpenGL.ImGui;
