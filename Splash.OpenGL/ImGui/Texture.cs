...
using System;
using Splash.API.OpenGL;
// WP-5.4: dead #if GLES / #elif GL / #elif LEGACY selector removed - none of those
// symbols is defined anywhere in the build. See ImGui/Controller.cs.
...
public enum TextureCoordinate
{
    ...
    // Splash.OpenGL where the swap needed a source change at all.
...
class Texture : IDisposable
{
    ...
    public void SetAnisotropy(float level)
    {
        ...
        _gl.TexParameter(GLEnum.Texture2D, (GLEnum)textureMaxAnisotropy,
            Single.Clamp(level, 1, MaxAniso.GetValueOrDefault()));
    }
