 ...
 * GlThreeD's _hasGL43 comment records it: a startup error was reported as "pre-existing"
 ...
 * nothing is wrong. GL_DEBUG_OUTPUT was ALREADY being enabled here - GlThreeD turned it
 ...
 * DESKTOP AND MOBILE
 *
 * This was desktop-only when first written, gated on GlThreeD's _hasGL43. That gate was
...
public static class GlDiagnostics
{
    ...
    /**
     * What this context can do, from the API name and version GlThreeD already parsed
